...
$(document).on('click','.woo-chatbot-lng-item-remove',function () {
  ...
  var stopWordsList={
    ...
    if($("input[type=radio][name='woo_chatbot_exitintent_show_pages']:checked").val()=='off'){

        $('#woo-chatbot-exitintent-show-pages-list').show('slow');

    }else{

        $('#woo-chatbot-exitintent-show-pages-list').hide('slow');
	...
	$('.woo-chatbot-exitintent-show-pages').on('change',function (e) {
