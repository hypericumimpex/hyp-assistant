...
class WPBotGCDownload
{
    ...
    public function __construct(){
        add_action('wp_ajax_qcld_woo_chatbot_gc_client_download', array($this, 'downloadgc'));
        add_action('wp_ajax_nopriv_qcld_woo_chatbot_gc_client_download', array($this, 'downloadgc'));
        add_action('wp_ajax_qcld_woo_chatbot_gc_client_extract', array($this, 'extractgc'));
        add_action('wp_ajax_nopriv_qcld_woo_chatbot_gc_client_extract', array($this, 'extractgc'));
    ...
    public function downloadgc(){
        $gcdirectory = ABSPATH. QCLD_wooCHATBOT_GC_DIRNAME;
    ...
    function extractgc(){
        $gcdirectory = ABSPATH.QCLD_wooCHATBOT_GC_DIRNAME;
        $gcfilename = ABSPATH.QCLD_wooCHATBOT_GC_DIRNAME.'/'.$this->filename;
        /* Open the Zip file */
        $zip = new ZipArchive;
